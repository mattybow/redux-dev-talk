...
class AuthPrompt{
	...
	render(){
		if(this.props.authPrompt.isVisible){
			...
			let oauthPath = `https://instagram.com/oauth/authorize/?client_id=1ca62ea2e3dc4fc5a9305493e5105f85&redirect_uri=http://localhost:5000/igapp/authResult&response_type=token`;
